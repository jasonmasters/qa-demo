...
class SystemTestsConfiguration:
    ...
    def __init__(self):
        self.projDir=None
        try:
            self.projDir = os.environ['PROJ_DIR']
        except:
            self.projDir = '..'
        ...
        self.nameOfTestExecutable = 'managerDriver.exe'
        ...
        self.masterListOfTestCases = [TestCase('Place_Order'), TestCase('Clear_Table'), TestCase('Get_Check_total'), TestCase('Add_Included_Dessert')]
